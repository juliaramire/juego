window.addEventListener('load', function(){
    ...
    class InputHandler {
        constructor(game){
            ...
            window.addEventListener('keydown', e =>{
                ...
                } else if (e.key ===' '){ //tecla espacio es el que dispara
    ...
    class Angler1 extends Enemy {
        constructor(game){
            ...
            this.frameY = Math.floor(Math.random() * 3);
            this.lives = 2; //cantidad de vidas del enemigo
            this.score = this.lives;
        }
    }
    ...
    class Backgroung {
        constructor(game){
            ...
            this.layer1 = new Layer(this.game, this.image1, 0.2); //la velocidad de la imagen
    ...
    class Explosion {
        ...
        draw(context){
            ...
            spriteHeight, 0, this.spriteHeight, this.spriteHeight, this.
...
class FireExplosion extends Explosion {
    ...
    class UI {
        ...
        draw(context){
            ...
            if(this.game.gameOver){
             ...
             //ammo
             if (this.game.player.powerUp) context.fillStylr = '#ffffbd';
    ...
    class Game {
        constructor(width, height){
            this.width = width;
            this.height = height;
            this.backgroung = new Backgroung(this);
        ...
        update(deltaTime){
            ...
            this.backgroung.update();
            this.backgroung.layer4.update();
            ...
            this.enemies.forEach(enemy => {
                ...
                if (this.checkCollision(this.player, enemy)){
                    ...
                    if (enemy.type === 'lucky') this.player.
                    enterPowerUp();
                        ...
                        if (enemy.lives <= 0){
                            for (let i = 0; i < enemy.score; i++){
                                this.particles.push(new Particle(this,
                                 enemy.x + enemy.width * 0.5, enemy.y +
                                 enemy.height * 0.5));
                            }
                            enemy.markedForDeletion =true;
                            this.addExplosion(enemy);
        ...
        draw(context){
            ...
            this.backgroung.layer4.draw(context);
        }
        addEnemy(){
